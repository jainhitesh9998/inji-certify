...
class Ed25519Signature2018ProofGeneratorTest {
    ...
    final Ed25519Signature2018ProofGenerator proofGenerator = new Ed25519Signature2018ProofGenerator();
    ...
    void detachedJwsVerifiesWithJca() throws Exception {
        ...
        assertEquals("EdDSA", header.getAlgorithm().getName());
        ...
        boolean ok = "Ed25519".equals("Ed25519") ? verifier.verify(signature)
