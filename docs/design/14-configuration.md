...
| `certify.offer-page` | offer page | `enabled` (false; P5-02) | new |
| `certify.protocol.vc-api` | vc-api adapter | `enabled` (false), `clients.<id>.secret`, `clients.<id>.credential-configurations` (P5-01; bearer-token clients later) | new |
